...
const utils_1 = __nccwpck_require__(350);
/**
 * Commands
 *
 * Command Format:
...
const oidc_utils_1 = __nccwpck_require__(290);
/**
...
const http_client_1 = __nccwpck_require__(522);
const auth_1 = __nccwpck_require__(537);
...
const pm = __nccwpck_require__(360);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(184);
            }
            const agentOptions = {
